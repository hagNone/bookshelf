...
from .views import RegisterView, VerifyOTPView , LoginView, Userprofile #, SendResetOTPView, ResetPasswordView,SearchBooksAPIView,BookDetailAPIView,user_logout,post_request
