...
from .views import RegisterView, VerifyOTPView , LoginView, Userprofile, Booklist, BookDetail, user_logout #, SendResetOTPView, ResetPasswordView,SearchBooksAPIView,post_request
